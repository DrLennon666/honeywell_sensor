...
import honey_decode_no_gui_epy_block_1_0 as epy_block_1_0  # embedded python block
import osmosdr
import time
...
class honey_decode_no_gui(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Honey Decode No Gui", catch_exceptions=True)
...
def main(top_block_cls=honey_decode_no_gui, options=None):
    tb = top_block_cls()
